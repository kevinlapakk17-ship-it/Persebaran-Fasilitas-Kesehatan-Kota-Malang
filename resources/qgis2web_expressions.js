...
function exp_JALAN_LN_25K_3rule0_eval_expression(context) {
    // REMARK = 'Jalan Kolektor'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('REMARK')  == 'Jalan Kolektor');
    } else {
        return (feature.get('REMARK')  == 'Jalan Kolektor');
    }
}
...
function exp_JALAN_LN_25K_3rule1_eval_expression(context) {
    // REMARK = 'Jalan Lain'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('REMARK')  == 'Jalan Lain');
    } else {
        return (feature.get('REMARK')  == 'Jalan Lain');
    }
}
...
function exp_JALAN_LN_25K_3rule2_eval_expression(context) {
    // REMARK = 'Jalan Lokal'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('REMARK')  == 'Jalan Lokal');
    } else {
        return (feature.get('REMARK')  == 'Jalan Lokal');
    }
}
...
function exp_JALAN_LN_25K_3rule3_eval_expression(context) {
    // REMARK = 'Jalan Setapak'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('REMARK')  == 'Jalan Setapak');
    } else {
        return (feature.get('REMARK')  == 'Jalan Setapak');
    }
}
...
function exp_JALAN_LN_25K_3rule4_eval_expression(context) {
    // REMARK = 'Jalan Tol Dua Jalur Dengan Pemisah Fisik'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('REMARK')  == 'Jalan Tol Dua Jalur Dengan Pemisah Fisik');
    } else {
        return (feature.get('REMARK')  == 'Jalan Tol Dua Jalur Dengan Pemisah Fisik');
    }
}